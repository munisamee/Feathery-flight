class Obstacles {
  constructor(gameScreen) {
    ...
    this.gameScreen.appendChild(this.elment);
  }
  ...
  updatePosition() {
    ...
    this.element.style.left = `${this.left}px`;
    this.element.style.right = `${this.right}px`;
    console.log("obstacle postion", this.element.getBoundingClientRect());
  }
  ...
  move() {
    ...
    //   this.top = Math.floor(Math.random() * 300 + 70); // Reset the vetical position
    // }
